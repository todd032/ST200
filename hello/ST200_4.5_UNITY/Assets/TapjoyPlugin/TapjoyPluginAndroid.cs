...
public class TapjoyPluginAndroid : MonoBehaviour
{
	...
	{
		// Communicate with java to build the dictionary
		transferDictionaryToJavaWithName(segmentationParams, TapjoyPluginAndroid.SEGMENTS_DICTIONARY_NAME);

		TapjoyConnectInstance.Call("sendSegmentationParams", TapjoyPluginAndroid.SEGMENTS_DICTIONARY_NAME);
	}
