...
public class EnemyNormalObject : EnemyObject {
	...
	*/
	...
	protected virtual IEnumerator Dead(){
		...
		//GameObject _go = PoolManager.Spawn("CFX_SmokeExplosion") ;
		//EnemyDeadEffectObjectTest _enemyDeadEffectObject = _go.GetComponent<EnemyDeadEffectObjectTest>() as EnemyDeadEffectObjectTest ;
		//_enemyDeadEffectObject.ResetEffectObject(_thisTransform.position) ;
		//_enemyDeadEffectObject.StartAction() ;
		...
		}else if(_enemyObjectType == EnemyObjectType.Enemy7){
			enemyObjectIndex = 111 ;
		}else if(_enemyObjectType == EnemyObjectType.Enemy8){
			enemyObjectIndex = 111 ;
		}
