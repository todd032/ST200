...
public class SubmarineEtcEffectBubbleCellSpriteObject : MonoBehaviour {
	...
	public virtual void InitSubmarineEtcEffectBubbleCellSpriteObject(){
		SetActiveSpriteObject(false) ;
	}
	
	public virtual void ResetSubmarineEtcEffectBubbleCellSpriteObject(Vector3 createPosition){
