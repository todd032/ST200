...
public class SubmarineEtcEffectExplosionCellSpriteObject : MonoBehaviour {
	...
	public virtual void InitSubmarineEtcEffectExplosionCellSpriteObject(){
		SetActiveSpriteObject(false) ;
	}
	
	public virtual void ResetSubmarineEtcEffectExplosionCellSpriteObject(Vector3 createPosition){
		...
		if(_cellColorType == CellColorType.White){
			...
			if(randomSelect == 0){
				_thisAnimatedSprite.color = new Color(100f/255f,100f/255f, 100f/255f, 1f) ;	
			}else if(randomSelect == 1){
				_thisAnimatedSprite.color = new Color(160f/255f,160f/255f, 160f/255f, 1f) ;	
			}else if(randomSelect == 2){
				_thisAnimatedSprite.color = new Color(220f/255f, 220f/255f, 220f/255f, 1f) ;
			}
			...
			_thisAnimatedSprite.color = new Color(120f/255f, 120f/255f, 120f/255f, 1f) ;	
