...
public class EnemyEffectExplosionCellSpriteObject : MonoBehaviour {
	...
	public enum CellColorType { White, Yellow , Blue, DarkGray} ;
	...
	public virtual void ResetEnemyEffectExplosionCellSpriteObject(Vector3 createPosition){
		...
		}else if(_cellColorType == CellColorType.DarkGray){
			int randomSelect = Random.Range(0, 3) ;
