...
public class EnemyEffectExplosionBaseSpriteObject : MonoBehaviour {
	...
	public virtual void InitEnemyEffectExplosionBaseSpriteObject(){
		SetActiveSpriteObject(false) ;
	}
	
	public virtual void ResetEnemyEffectExplosionBaseSpriteObject(Vector3 createPosition){
