...
public class PoolManager : MonoSingleton<PoolManager> //: MonoBehaviour
{
	#region Fields
	...
	*/
	...
	// DH Attach
	public void CreatePrefabPool(GameObject go, int makeAllocCount)
	{

		
	}
	
	public void CreatePrefabPool(GameObject go, int makeAllocCount, bool isLimit, int limitCount)
	{
